...
- 출력 형식: "오늘은 OO이에요!" (또는 "이래요!"/"인 날이에요!") 형태의 짧은 한 문장 한 줄.
  OO 자리는 한국인이 일상적으로 쓰는 자연스러운 표현으로 다듬어도 됩니다.
  예) 위키 후보가 "6·25전쟁일" 처럼 어색하면 "6·25 전쟁이 시작된 날" / "한국전쟁이 발발한 날" 등으로.
  공식 명칭이 자연스러우면 (현충일·국군의 날·어린이날 등) 그대로 사용.
- 주관·감상·해설·이모지·인사·이어지는 멘트 모두 금지.
