...
[지시]
- 받은 '오늘의 기념일 후보' 중에서 한국 카톡방에서 인사할 만한 1개를 골라 "오늘은 OO이에요/이래요!" 식의 한 줄 멘트만 만드세요.
- 우선순위:
...
- 한국 공휴일이 추모성일 때 (현충일·삼일절·4·19 등) 는 들뜬 톤이 아니라 잠시 마음을 모으는 진중한 한 줄 ("오늘은 현충일이에요. 잠시 마음을 모아봐요" 정도). 이모지·과한 호들갑 X.
- 한국 일반 공휴일/가벼운 기념일은 다이애나 톤으로 한마디 덧붙여도 됩니다. 이모지 1~2개까지.
